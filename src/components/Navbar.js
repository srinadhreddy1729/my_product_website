                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white rounded-lg shadow-lg p-5 mx-4 max-w-md overflow-y-auto" style={{ maxHeight: '80vh' }}>
                        ...
                        <p className="text-gray-700 mb-4">
                            With relevant experience in web and mobile application development, I am passionate about creating innovative and user-friendly solutions.
                        </p>
                        <p className="text-gray-700 mb-4">
                            I embarked on my freelance journey to combine my love for technology with the freedom to work on diverse projects.
                        </p>
                        <p className="text-gray-700 mb-4">
                            I believe in the power of communication and collaboration, striving to exceed my clients' expectations.
                        </p>
                        ...
                        <p className="text-gray-700 mb-4">
                            Feel free to <a href="#contact" className="text-indigo-500 underline">contact me</a> for any inquiries.
                        </p>
                        <button 
                            onClick={toggleModal} 
            ...
            <nav className="bg-gray-800">
                    ...
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    <a href="#contact" className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Contact Us</a>
                                    ...
                                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white" onClick={handleAboutMeClick}>About Me</a>
                                    <a href="#review" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Reviews</a>
                                </div>
                            </div>
                        </div>
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            <button type="button" className="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                ...
                                <span className="absolute top-0 right-0 inline-flex h-2.5 w-2.5 rounded-full bg-red-600 ring-2 ring-white"></span>
                            </button>
                            <div className="relative ml-3">
                                <div>
                                    <button type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        <img className="h-8 w-8 rounded-full" src={provider} alt="Profile" />
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div className={`sm:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu">
                    <div className="space-y-1 px-2 pb-3 pt-2">
                        <a href="#contact" className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Contact</a>
                        ...
                        <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white" onClick={handleAboutMeClick}>About Me</a>
                        <a href="#review" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Reviews</a>
                    </div>
                </div>
            </nav>
        </>
